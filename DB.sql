...
--
CREATE DATABASE
IF NOT EXISTS `VideoTube` DEFAULT CHARACTER
SET latin1
...
id`,
`postedBy
`, `videoId`, `responseTo`, `body`, `datePosted`) VALUES
...
id`,
`firstName
`, `lastName`, `username`, `email`, `password`, `signUpDate`, `profilePic`) VALUES
...
id`,
`uploadedBy
`, `title`, `description`, `privacy`, `filePath`, `category`, `uploadDate`, `views`, `duration`) VALUES
...
(158, 'donkey-kong', 'Woman walking
with phone', 'This is some stock footage I found', 1, 'uploads/videos/5bba245a573a3.mp4', 8, '2018-10-07 17:20:58', 7, '00:04'),
(159, 'mike123', 'Ducks! Awesome!', 'Here are some ducks. Enjoy!', 1, 'uploads/videos/5bba247a83798.mp4', 4, '2018-10-07 17:21:30', 0, '00:05'),
(160, 'reece-kenney', 'Table tennis
with my friends', 'My friends an I playing tennis', 1, 'uploads/videos/5bba2c77ae7d8.mp4', 5, '2018-10-07 17:55:35', 1, '00:09'),
...
ALTER TABLE `videos`
  MODIFY `id` int
(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=165;
COMMIT;
